...
const Interview = () => {
  ...
  if (!connected) {
    return (
      <section className="relative overflow-scroll min-h-screen bg-slate-950"><div className="absolute  p-8 flex flex-col items-center justify-center gap-3 bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f2e_1px,transparent_1px)] bg-[size:14px_24px]">
        <Loader />
      </div></section>
    )
  }
  ...
  return (
    blocker.state === "blocked" ? (
      ...
      <section className="relative overflow-scroll min-h-screen bg-slate-950"><div className="absolute  p-8 flex flex-col gap-8 bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f2e_1px,transparent_1px)] bg-[size:14px_24px]">
        <p className="first-letter:capitalize text-lg text-shadow-md font-semibold text-white">{name?.split("-").join(" ")}</p>
        {
          !connected ?
            ...
            (
              <>
                <div className="flex gap-8 flex-grow-12  ">
